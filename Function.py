...
def move_circle(master):
    if master.is_moving:
        ...
        circle_radius = 15  
        master.canvas.coords(master.circle, x - circle_radius, y - circle_radius, x + circle_radius, y + circle_radius)
...
def stopwatch(master,root):
    ...
    while not sw_stop_flag:
        master.sw_centi.set(("0"+str(int(master.sw_centi.get())+1))if len(str(int(master.sw_centi.get())+1))==1 else str(int(master.sw_centi.get())+1))
        time.sleep(0.014)
        if int(master.sw_centi.get()) ==60:
            master.sw_second.set(("0"+str(int(master.sw_second.get())+1))if len(str(int(master.sw_second.get())+1))==1 else str(int(master.sw_second.get())+1))
            master.sw_centi.set("00")
            if int(master.sw_second.get())==60:
                master.sw_second.set("00")
                master.sw_minute.set(("0"+str(int(master.sw_minute.get())+1))if len(str(int(master.sw_minute.get())+1))==1 else str(int(master.sw_minute.get())+1))
